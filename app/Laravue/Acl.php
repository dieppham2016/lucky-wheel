...
final class Acl
{
    ...
    const PERMISSION_PRIZE_MANAGE = 'manage prize';
    const PERMISSION_STATUS_MANAGE = 'manage status';
    const PERMISSION_MEDIA_MANAGER = 'manage media';
    const PERMISSION_GAME_MANAGER = 'manage game';

    const PERMISSION_VIEW_MENU_ADMINISTRATOR = 'view menu administrator';
    const PERMISSION_VIEW_MENU_GAME = 'view menu game';
    const PERMISSION_VIEW_GAME = 'view game';
